...
We also implemented 27 automated software tests covering the core system logic.
...
Beyond the published model metrics, we also validated the complete system through automated and functional testing.
...
In addition, all 27 automated software tests passed successfully.
...
Finally, we validated the complete application through automated and functional testing.
